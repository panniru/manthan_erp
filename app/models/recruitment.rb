class Recruitment < ActiveRecord::Base
  ...
  scope :application_forms, lambda{where("status = 'Application_Created' or status = 'Document_Verified' or status = 'Assessment_Planned'or status = 'Assessment_Completed'")}
