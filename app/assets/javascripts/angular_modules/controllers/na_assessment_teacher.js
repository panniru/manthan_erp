(function(angular, app) {
    "use strict";
    app.controller('NonAssessmentsTeacherController', ["$scope", "$location",  "assessmentsTeacherService", "teachersGradesService", "timeTableService", "assessmentsService", function($scope, $location , assessmentsTeacherService, teachersGradesService, timeTableService, assessmentsService) { 

        $('#na_assessments_calendar').fullCalendar({            
            selectable: true,
