(function(angular, app) {
    ...
    app.controller('NaAssessmentCriteriaController',["$scope", "na_assessmentCriteriaService", "academicsService","nonAcademicsService", function($scope, na_assessmentCriteriaService, academicsService, nonAcademicsService)  {
        ...
        {
            na_assessmentCriteriaService.getAssessmentCriteriaService(myGrade)
                .then(function(result) {
        ...
        $scope.editAssessmentCriteriaMappings = function()
        {
            ...
            nonAcademicsService.getNonAcademicsSubjects()
                .then(function(result) {
                    $scope.activity_masters=result.data;
                }); 
		...
		for (var j = 0; j < $scope.criterias.length; j++){
            ...
            na_assessmentCriteriaService.saveAssessmentCriteriaMappings($scope.save_assessment_criterias)
                .then(function(result) {                    
                });
