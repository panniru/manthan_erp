class RecruitmentSubMenu < Struct.new(:controller)
  ...
  def show_admin_assess_planned
    MenuItem.new(:label => "Assessment Planned ", :klass => "", :icon => "book", :href => "/staffrecruits/assess_index" )
  end

  def show_admin_assess_completed
    MenuItem.new(:label => "Assessment Completed ", :klass => "", :icon => "tasks", :href => "/staffrecruits/assess_completed_index" )
  end

  def admin_management_review
    MenuItem.new(:label => "Management Review", :klass => "", :icon => "calendar", :href => "/staffrecruits/admin_management_index" )
  end

  def home
    MenuItem.new(:label => "Home", :klass => "", :icon => "home ", :href => "/staffrecruits/recruitment_home")
  end
